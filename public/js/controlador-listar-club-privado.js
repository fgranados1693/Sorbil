...
let mostrar_tabla = async () => {
    ...
    for (let i = 0; i < lista_clubes.length; i++) {
        ...
        let celdaIconoUser = fila.insertCell();
        let aIconoUser = document.createElement('a');
        let iconUser = document.createElement('i');
        iconUser.className = 'bx bxs-user-detail';
        aIconoUser.appendChild(iconUser);
        ...
        if (lista_clubes[i].estado == 'habilitado') {
            ...
            aIconoUser.className = 'list-icon';
            aIconoUser.addEventListener('click', function () {
                window.location.href = `p-listar-club-usuarios.html?_id=${lista_clubes[i]['_id']}`;
            });
            ...
            aIconoUser.className = 'list-iconDisable';
            iconAc.addEventListener('click', function () {
        ...
        celdaIconoUser.appendChild(aIconoUser);
