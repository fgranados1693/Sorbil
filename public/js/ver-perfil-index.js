...
btn_perfil2.addEventListener('click', function () {
        switch (typeUser) {
                case 'u':
                        ...
                        break;
                case 'al':
                        window.location.href = `./views/ver-perfil-administrador-libreria.html?_id=${id_ensesion}`;
                        break;
                case 'ap':
                        window.location.href = `./views/ver-perfil-administrador-plataforma.html?_id=${id_ensesion}`;
                        break;
        }
